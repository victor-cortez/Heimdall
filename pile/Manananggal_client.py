...
import sys
import time
from pile import pile as main
print("Manananggal client version 1.0.0 for UCA Cluster, based in Heimdall")
...
while True:
    ...
    while True:
        ...
        try:
            ...
            resposta = mysock.recv(1048576).decode("utf-8") #receives the task or the waiting command
            mysock.close()
            ...
            break
        try:
            inputs = int(resposta) #converts the data to input
            ...
            break
        try:
            final = "done|" + str(resultado) #formats the resulting data as the protocol demands
